...
<div id="modal" class="fixed inset-0 hidden bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-lg w-[500px]">
        <div class="flex justify-between items-center p-4 border-b">
            <h3 class="text-xl font-semibold text-black">Modal Title</h3>
            <button id="closeModal" class="text-black hover:text-gray-700">&times;</button>
        </div>
        <div class="p-4">
            <p>This is the modal content.</p>
        </div>
        <div class="flex justify-end p-4 border-t">
            <button id="closeModalFooter" class="px-4 py-2 bg-gray-500 text-white rounded mr-2">Close</button>
