        ...
        <div class="mt-[120px] p-10 bg-light1 w-1/1 ms-[347px] rounded-lg me-[30px]">
            <form class="mx-auto space-y-5" action="{{ route('admin.update-data-pembelian',['kode_pembelian' => $data->kode_pembelian])}}" method="POST">
                ...
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="w-full md:w-1/2 px-3 mb-5">
                        <div class="relative z-0 w-full group">
                            <input type="text" name="tanggal_pembelian" id="bulan" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-purple-600 peer" placeholder=" " value="{{ $data->bulan }}" />
