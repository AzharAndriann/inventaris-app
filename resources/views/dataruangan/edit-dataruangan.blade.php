...
<div class="wrapper bg-light2 flex">
    ...
    <div class="main bg-light2 flex-grow">
        ...
        <div class="mt-[120px] p-10 bg-light1 w-1/1 ms-[347px] rounded-lg me-[30px]">
            <form class="mx-auto" action="{{ route('admin.update-ruang',['id'  => $ruang->id])}}" method="POST">
                @method('PUT')
                @csrf
                <div class="relative z-0 w-full mb-5 group">
                    <input type="name" name="kode_ruangan" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-purple-600 peer" placeholder="" value="{{$ruang->kode_ruangan}}" required />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="name" name="nama_ruangan" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-purple-600 peer" placeholder="" value="{{$ruang->nama_ruangan}}" required />
