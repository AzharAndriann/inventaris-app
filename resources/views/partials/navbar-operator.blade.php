<nav class="navbar navbar-expand px-3 fixed-top w-1/1 ms-[344px]  bg-light1 bg-opacity-70  mt-6 border-2 border-slate-200 mx-[28px] rounded-lg backdrop-blur-md backdrop-brightness-150 shadow-md">
    <div class="navbar-collapse navbar">
        <div class="flex flex-col">
            <div class="text-lg text-slate-500">Pages  <span class="text-sm text-slate-700">/</span>  <span class="text-slate-700">Operator</span></div>
        </div>
        <ul class="navbar-nav">
