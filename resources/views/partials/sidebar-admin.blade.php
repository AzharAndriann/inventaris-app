...
<aside class="fixed w-[300px] h-full bg-light1 text-slate-800 backdrop-blur-3xl opacity-80 mt-6 ms-3 rounded-lg shadow-lg">
    ...
    <ul class="p-4 space-y-2">
        ...
        <li data-id="data-pemakaian">
            <a href="{{ route('admin.data-pemakaian')}}"class="flex items-center p-2 space-x-2 text-slate-900 hover:bg-gradient-to-bl duration-300 from-pink-600 via-fuchsia-600 to-purple-600 hover:text-white  rounded-md">
